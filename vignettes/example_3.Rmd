...
## 1.1 Introduction
In this tutorial, we are going to learn a simple, yet powerful JS library called [`p5.js`](https://p5js.org/) [[1]](#note_1). The goal of the tutorial is to learn the basics of p5.js in preparation for creating the following two apps:
<div align='center'>
...
- some common functions: `rect, line` and `ellipse` for creating simple geometric objects, `mouseIsPressed, mouseX` and `mouseY` for managing mouse events. 
